        ...
        for row in range(ROWS):
            for col in range(COLS):
                ...
                if row == 7:
                    ...
                    lbl_pos = (col * SQSIZE + SQSIZE - 20, SIDE_LENGTH - 20)
                    # blit
                    surface.blit(lbl, lbl_pos)
    ...
    def show_moves(self, surface):
        ...
        if self.dragger.dragging:
            ...
            for move in piece.moves:
                ...
                # rect
                pos = (move.final.col * SQSIZE + SQSIZE // 2, move.final.row * SQSIZE + SQSIZE // 2)

                # has piece?
                if self.board.squares[move.final.row][move.final.col].isempty():
                    pygame.draw.circle(surface, color, pos, 16)
                else:
                    pygame.draw.circle(surface, color, pos, SQSIZE//2.15, 8)
